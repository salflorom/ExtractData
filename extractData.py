# Author: Santiago Alberto Flores Roman
...
class CP2K(Extract):
    ...
    def ReadInputFiles(self):
        ...
        inpFileName, enerFileName, outFileName = '', '', ''
        inpFileFound, enerFileFound, outFileFound = False, False, False
        for fileName in os.listdir(path):
            if fileName.endswith('.out'): listOutFiles.append(fileName)
            elif fileName.endswith('.xyz'): listxyzFiles.append(fileName)
...
class NEBMethod(CP2K):
    ...
    def PrintInputParameters(self):
        ...
        enerFileName = self.enerFileName
        ...
        print(f'\tCreate figures: {createFigures}')
        print(f'\tCreate output file: {createOutFile}')
        print(f'\tInput file: {inpFileName}')
        print(f'\tEnergy file: {enerFileName}')
        print(f'\tList of out files:')
        for i in range(len(listOutFiles)):
            print(f'\t\t{listOutFiles[i]}')
